    ...
    >
      ...
      >
        ...
        <div className="px-4 sm:px-6 py-5 space-y-4">
          ...
          {/* Brief visual / Prompt IA generativa */}
          <div className="border-t border-surface-100 pt-4 mt-2 space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-bold text-surface-800 uppercase tracking-wider">Brief visual</h4>
              {onGenerateBrief && (
                <button
                  type="button"
                ...
                >
                  {generatingBrief ? 'Generando...' : visualBrief.trim() ? 'Regenerar brief' : 'Generar brief'}
                </button>
              )}
            </div>

            <div>
              <label className="block text-sm font-medium text-surface-700 mb-1.5">Instrucciones para el diseñador</label>
              <textarea
                value={visualBrief}
                onChange={e => setVisualBrief(e.target.value)}
                rows={8}
                placeholder="Se rellena al generar el brief o puedes escribirlo a mano…"
                className="w-full px-3 sm:px-4 py-2.5 rounded-xl border border-surface-200 bg-white text-surface-900 focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 resize-y text-sm leading-relaxed whitespace-pre-wrap min-h-[120px]"
              />
            </div>

            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-sm font-medium text-surface-700">Prompt para IA generativa</label>
                <button
                  type="button"
                  onClick={() => {
              ...
              <textarea
                ...
                rows={5}
                placeholder="Prompt para herramientas generativas…"
                className="w-full px-3 sm:px-4 py-2.5 rounded-xl border border-surface-200 bg-surface-50 text-surface-900 focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 resize-y text-xs font-mono leading-relaxed whitespace-pre-wrap"
              />
            </div>
          </div>
        </div>
